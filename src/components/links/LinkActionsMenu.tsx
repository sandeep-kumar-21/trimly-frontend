...
export const LinkActionsMenu: React.FC<LinkActionsMenuProps> = ({ link }) => {
  ...
  return (
    <>
      <Dropdown
        trigger={
          <button className="rounded-lg p-1.5 text-slate-400 hover:bg-slate-100 hover:text-slate-700 dark:hover:bg-slate-800 dark:hover:text-slate-200 transition-colors">
